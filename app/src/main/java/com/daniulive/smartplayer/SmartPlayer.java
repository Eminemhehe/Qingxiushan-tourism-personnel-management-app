...
public class SmartPlayer extends Activity implements SurfaceHolder.Callback {
    ...
    private void PopFullUrlDialog() {
        ...
        inputUrlTxt.setText("rtmp://play.gxuc.net/lilienapp/lilistream");
    ...
    private void inflateLayout(int orientation) {
        ...
        btnSwitchUrl.setVisibility(View.GONE);
        ...
        btnFlipVertical.setVisibility(View.GONE);
        ...
        btnFlipHorizontal.setVisibility(View.GONE);
        ...
        btnHardwareDecoder.setVisibility(View.GONE);
        ...
        btnSetPlayBuffer.setVisibility(View.GONE);
        ...
        btnLowLatency.setVisibility(View.GONE);
        ...
        btnFastStartup.setVisibility(View.GONE);
        ...
        btnStartStopRecorder.setVisibility(View.GONE);
        ...
        btnSwitchUrl.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
        ...
        btnRecoderMgr.setVisibility(View.GONE);
    ...
    public Action getIndexApiAction() {
        Thing object = new Thing.Builder()
                .setName("SmartPlayer Page") // TODO: Define a title for the content shown.
